...
void main() {
  ...
  group('Database Migration V1 to V2', () {
    ...
    setUp(() async {
      ...
      // Manually run V2 migration SQL (simulates onUpgrade)
      await db.execute(
    ...
    test(
        'should add ease_factor, interval_days, repetitions, and learning_state columns to progress table',
        () async {
      final List<Map<String, dynamic>> columns =
          await db.rawQuery('PRAGMA table_info(progress);');
    ...
    test('should create study_sessions and learning_events tables successfully',
        () async {
