...
void main() {
  ...
  group('ReviewScheduler Rules', () {
    test('should return SchedulingStatus.overdue when next review date has passed', () {
    ...
    test('should return SchedulingStatus.decaying when next review has passed for > 7 days and EF is low', () {
      final card = ReviewCard(
        word: tWord,
        learningState: LearningState.reviewing,
        isDue: true,
    ...
    test('should return SchedulingStatus.due when next review is within 24 hours of now', () {
      final card = ReviewCard(
        word: tWord,
        learningState: LearningState.reviewing,
        isDue: true,
    ...
    test('should return SchedulingStatus.future when next review is far in the future', () {
      final card = ReviewCard(
        word: tWord,
        learningState: LearningState.reviewing,
        isDue: false,
