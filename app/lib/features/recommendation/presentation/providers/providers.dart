...
export 'recommendation_notifier.dart';
...
final completeRecommendationUseCaseProvider =
    Provider<CompleteRecommendationUseCase>((ref) {
  return sl();
});
...
final recommendationProvider =
  ...
  return RecommendationNotifier(
    ...
    dismissRecommendationUseCase:
        ref.watch(dismissRecommendationUseCaseProvider),
    completeRecommendationUseCase:
        ref.watch(completeRecommendationUseCaseProvider),
  );
});
